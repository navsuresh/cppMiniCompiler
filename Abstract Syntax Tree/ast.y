...
postfix_expression
	...
	| postfix_expression '[' expression ']'{$$=mknode($1,$3,"[]");}
	| postfix_expression '(' ')'{$$=$1;}
	| postfix_expression '(' argument_expression_list ')' {$$=mknode($1,$3,"()");}
	| postfix_expression '.' IDENTIFIER{$$=mknode($1,mknode(0,0,yytext),".");}
